...
if (initialisationFaite = 0) then
   ...
   procedure initialiser (compteur :  out Integer; valeur : in Integer)
   IS 
   begin
		compteur := valeur;
   end;
     ...
     function valeursEgales (valeur1 : in Integer; valeur2 : in Integer)  return Boolean
	 is
	 begin
		return valeur1 = valeur2;
	 end valeursEgales ;
	 
   procedure ajouterUn (compteur : in out Integer)
   is
   begin
		compteur := compteur + 1 ;
	 end ajouterUn ;
	 
	procedure ajouterN (compteur : in out Integer; n : in Integer)
	is
	begin
		compteur := compteur + n ;
	end ajouterN ;	
	 
procedure soustraireUn (compteur : in out Integer)
   is
   begin
		compteur := compteur - 1 ;
	 end soustraireUn ;
